...
<div>
    <h4 class="mb-4 text-center text-white">{{ __('Verifica tu correo electrónico') }}</h4>
    ...
    <div class="gap-3 d-flex flex-column flex-sm-row align-items-center justify-content-between">
